...
# Handle missing _import_utils module
try:
    from torch.utils import _import_utils
except ImportError:
    import sys
    import types
    sys.modules['torch.utils._import_utils'] = types.ModuleType('torch.utils._import_utils')
    sys.modules['torch.utils._import_utils'].dill_available = False
...
dir_input2 = 'D:/microplastics/model/polyDTA/test_input/'
